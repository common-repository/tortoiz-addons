...
/**
 * Tortoiz_Addons_Ext_Icon icon control.
 *
 * Tortoiz_Addons_Ext_Icon class extends the icons.
 *
 * @since 3.0.1
 */
class Tortoiz_Addons_Ext_Icon extends Base_Data_Control{
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'tortoiz-addons-ext' ); ?>">
					<option value=""><?php echo __( 'Select Icon', 'tortoiz-addons-ext' ); ?></option>
