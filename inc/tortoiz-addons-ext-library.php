...
/**
 * Tortoiz_Addons_Ext_Library Class for remote library.
 *
 * @since 3.0.0
 */
class Tortoiz_Addons_Ext_Library extends Source_Base {
	...
	public function get_id() {
		return 'tortoiz_addons_ext_templates';
	}
	...
	public function get_title() {
		return __( 'Tortoiz Templates', 'tortoiz-addons-ext' );
	}
	...
	public function get_data( Array $args, $context = 'display' ) {
		$type 		= get_option( 'tortoiz_addons_ext_type' );
		$key 		= ('pro' ==  $type) ? get_option( 'tortoiz_addons_ext_pro_license_key' ) : get_option( 'tortoiz_addons_ext_license_key' );
		$temp_id 	= str_replace( 'tortoiz_addons_ext_', '', $args['template_id'] );
	...
	public function get_item( $template_data ) {
		...
		return [
			'template_id' => 'tortoiz_addons_ext_'. $template_data['id'],
			'source' => 'remote',
			...
			'favorite' => ! empty( $favorite_templates[ 'tortoiz_addons_ext_'.$template_data['id'] ] ),
		];
	}
	 ...
	 * @since 3.0.0
	 */
	public static $api_info_url = 'https://plugins.shaontortoizAddons.com/api/v1/tortoiz-addons-ext/get/?data=lib';
	 ...
	 * @since 3.0.0
	 */
	private static $api_get_template_content_url = 'https://plugins.shaontortoizAddons.com/api/v1/tortoiz-addons-ext/get/?data=%d';
}